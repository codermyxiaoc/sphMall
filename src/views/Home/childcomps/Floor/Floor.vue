            ...
            <div class="title clearfix">
                ...
                <div class="fr">
                    <ul class="nav-tabs clearfix">
                        <li class="active" v-for="item in flooritem.navList" :key="item.text">
            ...
            <div class="tab-content">
                <div class="tab-pane">
                    <div class="floor-1">
                        <div class="blockgary">
                            <ul class="jd-list">
                                <li v-for="item in flooritem.keywords" :key="item">{{item}}</li>
                            </ul>
                            <img :src="flooritem.imgUrl" />
                        </div>
                        <div class="floorBanner">
                            <swiper :imglist="flooritem.carouselList"></swiper>
