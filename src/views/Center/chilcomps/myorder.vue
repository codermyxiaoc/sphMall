    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="item in aothdata.records" :key="item.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                    ...
                    <tbody>
                        <tr v-for="(orderitem,index) in item.orderDetailList" :key="orderitem.sourceId">
                            <td width="60%">
                            ...
                            <td :rowspan="item.orderDetailList.length" v-if="index === 0" width="13%" class="center">
                                <ul class="unstyled">
                                    <li>总金额¥{{ orderitem.splitTotalAmount }}</li>
                                    <li>在线支付</li>
            ...
            <div class="choose-order">
                <pagination :pagedata="{ pageNo: page, pageSize: limit, total: aothdata.total, continus: 5}"
                    @getPageON="getpageON">
                </pagination>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async getdate() {
            let result = await reqauth(this.page, this.limit)
            if (result.code === 200) {
                this.aothdata = result.data
            }
        },
        getpageON(page) {
            this.page = page
